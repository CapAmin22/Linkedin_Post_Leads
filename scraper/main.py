...
_EMAIL    = os.environ.get("LINKEDIN_EMAIL") or os.environ.get("NEXT_PUBLIC_LINKEDIN_EMAIL", "")
_PASSWORD = os.environ.get("LINKEDIN_PASSWORD") or os.environ.get("NEXT_PUBLIC_LINKEDIN_PASSWORD", "")
